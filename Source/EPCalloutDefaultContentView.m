...
static CGFloat const EPCalloutViewInterLabelMargin = 10.0;
static CGFloat const EPCalloutViewLabelToAccessorySpacing = 8.0;

static NSString * const EPCalloutDiscolsureArrowRightImageName = @"EP_DisclosureArrowRight";

@interface EPCalloutViewDefaultContentView ()
...
@implementation EPCalloutViewDefaultContentView
...
- (void)setupAccessoryView {
    ...
    self.accessoryView.image = [UIImage imageNamed:EPCalloutDiscolsureArrowRightImageName];
...
- (void)setupTitleLabel {
    ...
    right = [NSLayoutConstraint constraintWithItem:self.titleLabel
                                         ...
                                         attribute:NSLayoutAttributeLeft
                                        multiplier:1.0
                                          constant:-EPCalloutViewLabelToAccessorySpacing];
...
- (CGSize)sizeThatFits:(CGSize)size {
    ...
    CGFloat height = titleLabelSize.height + subtitleLabelSize.height + EPCalloutViewInterLabelMargin;
    
    width += EPCalloutViewLabelToAccessorySpacing + self.accessoryViewWidthConstraint.constant + self.accessoryViewRightConstraint.constant;
